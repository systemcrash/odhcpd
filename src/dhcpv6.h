...
/* RFC5007 */
#define DHCPV6_STATUS_UNKNOWN_QUERY_TYPE 7
#define DHCPV6_STATUS_MALFORMED_QUERY 8
#define DHCPV6_STATUS_NOT_CONFIGURED 9
#define DHCPV6_STATUS_NOT_ALLOWED 10

/* OPTION_LQ_QUERY OPTION CODES */
/* RFC5007 */
#define DHCPV6_QUERY_BY_ADDRESS 1
#define DHCPV6_QUERY_BY_CLIENTID 2
